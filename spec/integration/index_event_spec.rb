  ...
  it_should_behave_like "HTTPS" do
    ...
    context 'when user token is invalid' do
      before do
        ...
        get_events(token: 'invalid_token')
      end
    ...
    context 'when user token is valid and search params exist in db' do
      ...
      before do
        ...
        get_events(token: user.token, search: "Bob's party")
      end
